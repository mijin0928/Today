            ...
            {todo.map((todo: Todo, idx) => (
              ...
              >
                <input
                  ...
                  type='checkbox'
                />
                <label className='ml-20 cursor-pointer' htmlFor={`check${idx + 1}`}>
                  {todo.text}
                </label>
                <button
                  className='absolute top-[50%] right-[2rem] translate-y-[-50%] overflow-hidden w-11 h-11 indent-[100%] whitespace-nowrap bg-remove bg-no-repeat bg-contain hover:bg-removeOn'
                  type='button'
